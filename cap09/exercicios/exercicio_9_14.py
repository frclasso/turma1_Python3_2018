#!/usr/bin/env python3
# -*-coding:utf-8 -*-
"""Crie um programa que leia um arquivo-texto e elimine os espaços
 repetidos entre as palavras e no fim das linhas. O arquivo de saída
  também não deve ter mais de uma linha em branco repetida."""
