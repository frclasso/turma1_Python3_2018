...
"""Modifique o programa para também controlar a data de aniversário
...
def mostra_dados(nome, telefone, email, aniversario):
    print("Nome: {}\nTelefone: {}\nEmail:"
          " {}\nAniversário: {}\n".format(nome,telefone,email,aniversario))
...
def altera():
    ...
    if p != None:
        ...
        print("Encontrado:")
        mostra_dados(nome, telefone, email, aniversario)
...
def le():
    global alterada
    if alterada:
        print("Você não salvou a lista desde a última alteração. "
              "Deseja gravá-la agora?")
