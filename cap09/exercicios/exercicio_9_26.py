...
"""Altere o programa de forma a verificar a repetição de nomes.
...
def pede_nome_arquivo(): # pode colocar um default
...
# esta funcao foi alterada em relacao ao arquivo 9.25
def novo():
